    ...
    <div class="detail">
        <article class="sinfo_main">
            ...
            <%-- <div class="info_top">
                ...
                <div class="bar_con">
                    <form action="${pageContext.request.contextPath }/student/updateStudent.do?id=${student.id}" method="post" enctype="multipart/form-data">
                        <div class="add_con">
                            <h2>学生信息</h2>
                            <div class="info_con">
                                <div class="add_left">
                                ...
                                <div>
                                        ...
                                        <input name="name" value="${student.name }" type="text" class="text" />
                                        <span></span>
                                    </div>
                                    <div>
                                        <label>学号：</label>
                                        <input name="num" value="${student.num }" type="text" class="text" />
                                        <span></span>
                                    </div>
                                    <div>
                                        <label><span>*</span>年级：</label>
                                   <select name="grade">
                                          <option value="${gra.id}" <c:if test="${student.grade!=null}">selected=selected</c:if>>${gra.name}</option>
                                          <!-- <option value="">请选择年级</option> -->
                                          <c:forEach items="${grades }" var="grade">
					                      <option value="${grade.id }"<c:if test="${grade.id==gra.id}">display=none</c:if>>${grade.name}</option>
					                    </c:forEach>
                                   </select>
                                        <span></span>
                                    </div>
                                    <div>
                                     ...
                                     <select name="classid">
                                            ...
                                            <option value="${cla.id}" <c:if test="${student.classid!=null}">selected=selected</c:if>>${cla.name}</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="sex">
                                            ...
                                            <option value="${student.sex}" <c:if test="${student.sex!=null}">selected=selected</c:if>>${student.sexview}</option>
                                    ...
                                    <div>
                                        ...
                                        <input name="birthday" value="${student.birthday }" class="Wdate" type="text" onClick="WdatePicker()">
                                        <span></span>
                                    </div>
                                    <div>
                                        <label>入学时间：</label>
                                        <input name="intime" value="${student.intime }" class="Wdate" type="text" onClick="WdatePicker()">
                                    </div>
                                    <div>
                                        <label>身份证号：</label>
                                        <input name="idNum" type="text" value="${student.idNum }"/>
