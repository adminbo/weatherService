    ...
    <div class="detail">
        <article class="contact_main">
            ...
            <div class="contact_con">
                <h2>家长信息</h2>
                <div class="contact_look">
                    <div class="search">
                        <div>
                            <label>学生姓名：</label>
                            <input type="text" value="王小五" disabled="disabled"/>
                        </div>
                    </div>
                    <div class="search">
                        <div>
                    ...
                    <div class="parents">
                        <div class="par_con">
                            ...
                            <div class="par_right">
                                <div>
                                    <label>姓名：</label>
                                    <input type="text" value="李志伟" disabled="disabled"/>
                                </div>
                                <div>
                                    <label>性别：</label>
                                    <input type="text" />
                                ...
                                <div>
                                    <label>关系：</label>
                                    <input type="text" value="母子" disabled="disabled"/>
                                </div>
                                <div>
                                    <label>手机：</label>
                                    <input type="text" value="13764586575" disabled="disabled"/>
                                    <p></p>
                                </div>
                                <div>
                                    <label>微信号：</label>
                        ...
                        <div class="par_con">
                            ...
                            <div class="par_right">
                                <div>
                                    <label>姓名：</label>
                                    <input type="text" value="王兵" disabled="disabled"/>
                                </div>
                                <div>
                                    <label>性别：</label>
                                    <input type="text" />
                                ...
                                <div>
                                    <label>关系：</label>
                                    <input type="text" value="父子" disabled="disabled"/>
                                </div>
                                <div>
                                    <label>手机：</label>
                                    <input type="text" value="13838980344" disabled="disabled"/>
                                    <p></p>
                                </div>
                                <div>
                                    <label>微信号：</label>
                        ...
                        <div class="par_con">
                            ...
                            <div class="par_right">
                                <div>
                                    <label>姓名：</label>
                                    <input type="text" value="李群" disabled="disabled"/>
                                </div>
                                <div>
                                    <label>性别：</label>
                                    <input type="text" />
                                ...
                                <div>
                                    <label>手机：</label>
                                    <input type="text" value="1777482343" disabled="disabled"/>
                                    <p></p>
                                </div>
                                <div>
                                    <label>微信号：</label>
                        ...
                        <div class="par_con">
                            ...
                            <div class="par_right">
                                <div>
                                    <label>姓名：</label>
                                    <input type="text" value="王明" disabled="disabled"/>
                                </div>
                                <div>
                                    <label>性别：</label>
                                    <input type="text" />
...
<div class="easyui-window import_con" id="import_con">
    ...
    <div class="btn">
        ...
        <a href="${pageContext.request.contextPath }/toshowjiazhangxietong.do"><button class="close" type="button">关闭</button></a>
    </div>
</div>
