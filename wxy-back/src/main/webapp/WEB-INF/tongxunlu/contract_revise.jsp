                    ...
                    <div class="parents">
                        <div class="par_con">
                            ...
                            <div class="par_right">
                                ...
                                <div>
                                    <label>关系：</label>
                                    <input type="text" value="母子"/>
                                </div>
                                <div>
                                    <label>手机：</label>
                                    <input type="text" value="13234563423"/>
                                    <p></p>
                                </div>
                                <div>
                                    <label>微信号：</label>
...
<div class="easyui-window import_con" id="import_con">
    ...
    <div class="btn">
        <button type="submit" class="save">保存</button>
        <a href="${pageContext.request.contextPath }/toeditjiazhangxietong.do"><button class="close" type="button">关闭</button></a>
    </div>
</div>
