    ...
    <div class="detail">
        <article class="facility_main">
            <section class="top">
                ...
                <a href="${pageContext.request.contextPath }/getAllPeitaosheshi.do" target="leftFrame">配套设施</a>
            </section>
            <div class="campuscon">
                <ul>
      ...
      <%--               <li>
                        <figure>
                            <img src="${pageContext.request.contextPath }/images/campus2.jpg" />
                            <figcaption>
                                <label>标题：</label>
                                <input type="text"/>
                            </figcaption>
                        ...
                        <div class="mask"></div>
                        <div class="ico">
                            <button type="button" class="up"><img src="${pageContext.request.contextPath }/images/up.png" /></button>
                    ...
                    <li id="addLi" class="upload" style="display:none">
                    	<form id="form" action="${pageContext.request.contextPath }/addSchoolEqu.do" method="post" enctype="multipart/form-data">
                        <figure>
                            <div class="img">
                                <span>选择图片
                        ...
                        <script type="text/javascript">
                        	...
                        	function del(id){
                        		...
                        		if(flag){
                        			location.href='equ/deleteById.do?id='+id;
                        		}
                        	}
                        	function picShow(id,isdown){ //显示图片，上架
                        		...
                        		if(flag){
                        			location.href='equ/showPicById.do?id='+id;
                        		}
                        	}
                        	function picNoShow(id,isdown){ //bu显示图片，下架
                        		...
                        		if(flag){
                        			location.href='equ/noShowPicById.do?id='+id;
                        		}
                        	}
                        </script>
                        </form>
           ...
           <%--          <li class="upload">
                        <figure>
                            ...
                            <figcaption>
                                <label>标题：</label>
                                <input type="text" placeholder="新建图片"/>
                            </figcaption>
                        </figure>
                        <div class="mask"></div>
                        <div class="ico">
