...
$(function(){
    ...
    var pro1=$("#province1");
    var city1=$("#city1");
    var dAC1=$("#districtAndCounty1");
    var num3=null;
    var num4=null;
    init1();
    var pro2=$("#province2");
    var city2=$("#city2");
    var dAC2=$("#districtAndCounty2");
    var num5=null;
    var num6=null;
    init2();
    pro.change(function(){
    	city.html("<option value='' >地级市</option>");
    	dAC.html("<option  value=''>市、县级市</option>");
        ...
        if(num1!==0){
            for(var i=0;i<province[num1-1].city.length;i++){
                var $temp=$("<option value='"+province[num1-1].city[i].name+"'>"+province[num1-1].city[i].name+"</option>");
                city.append($temp);
            }
        }
    });
    pro2.change(function(){
    	city2.html("<option value='' >地级市</option>");
    	dAC2.html("<option  value=''>市、县级市</option>");
    	num5=pro2.prop("selectedIndex");
    	city2.find("option").eq(0).siblings().remove();
    	dAC2.find("option").eq(0).siblings().remove();
    	if(num5!==0){
    		for(var i=0;i<province[num5-1].city.length;i++){
    			var $temp=$("<option value='"+province[num5-1].city[i].name+"'>"+province[num5-1].city[i].name+"</option>");
    			city2.append($temp);
    		}
    	}
    });
    pro1.change(function(){
    	city1.html("<option value='' >地级市</option>");
    	dAC1.html("<option  value=''>市、县级市</option>");
    	num3=pro1.prop("selectedIndex");
    	city1.find("option").eq(0).siblings().remove();
    	dAC1.find("option").eq(0).siblings().remove();
    	if(num3!==0){
    		for(var i=0;i<province[num3-1].city.length;i++){
    			var $temp=$("<option value='"+province[num3-1].city[i].name+"'>"+province[num3-1].city[i].name+"</option>");
    			city1.append($temp);
    		}
    	}
    });
    city.change(function(){
        ...
        if(num2!==0){
            for(var i=0;i<province[num1-1].city[num2-1].districtAndCounty.length;i++){
                var $temp=$("<option value='"+province[num1-1].city[num2-1].districtAndCounty[i]+"'>"+province[num1-1].city[num2-1].districtAndCounty[i]+"</option>");
                dAC.append($temp);
            }
        }
    })
    city2.change(function(){
    	dAC2.html("<option  value=''>市、县级市</option>");
    	num6=city2.prop("selectedIndex");
    	dAC2.find("option").eq(0).siblings().remove();
    	if(num6!==0){
    		for(var i=0;i<province[num5-1].city[num6-1].districtAndCounty.length;i++){
    			var $temp=$("<option value='"+province[num5-1].city[num6-1].districtAndCounty[i]+"'>"+province[num5-1].city[num6-1].districtAndCounty[i]+"</option>");
    			dAC2.append($temp);
    		}
    	}
    })
    city1.change(function(){
    	dAC1.html("<option  value=''>市、县级市</option>");
    	num4=city1.prop("selectedIndex");
    	dAC1.find("option").eq(0).siblings().remove();
    	if(num4!==0){
    		for(var i=0;i<province[num3-1].city[num4-1].districtAndCounty.length;i++){
    			var $temp=$("<option value='"+province[num3-1].city[num4-1].districtAndCounty[i]+"'>"+province[num3-1].city[num4-1].districtAndCounty[i]+"</option>");
    			dAC1.append($temp);
    		}
    	}
    })
...
function init(){
    ...
    for(var i=0;i<province.length;i++){
        var $temp=$("<option value='"+province[i].name+"'>"+province[i].name+"</option>");
        pro.append($temp);
    }
}
function init2(){
